...
export default class StockRepositoryDatabase implements StockRepository {
    ...
    async save(stockEntry: StockEntry): Promise<void> {
        this.databaseConnection.query("insert into diapers.stock_entry (id_item, operation, quantity, date) values ($1, $2, $3, $4)", [stockEntry.idItem, stockEntry.operation, stockEntry.quantity, new Date()]);
    }
